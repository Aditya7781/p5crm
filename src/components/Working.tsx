...
const sampleRows: WorkingRow[] = Array.from({ length: 48 }).map((_, i) => ({
                  ...
                  <Td>
                    <div className="flex items-center gap-2">
                      <button
                        className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-500 text-white hover:bg-blue-600 transition"
                        title="Edit Figma"
                        aria-label={`Edit Figma for project ${r.projectId}`}
                        onClick={() =>
                          alert(`Edit Figma for project ${r.projectId}`)
                        }
                      >
                      ...
                      <button
                        className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-500 text-white hover:bg-blue-600 transition"
                        title="Upload Figma"
                        aria-label={`Upload Figma for project ${r.projectId}`}
                        onClick={() =>
                          alert(`Upload Figma for project ${r.projectId}`)
                        }
                      >
